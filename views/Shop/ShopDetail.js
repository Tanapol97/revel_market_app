...
export class ShopDetail extends React.Component {
    ...
    render() {
                    ...
                    <View>
                        ...
                        <View style={{ padding: 16, }}>
                            ...
                            <View style={{ flexDirection: 'row', marginBottom: 4 }}>
                                ...
                                <Text style={[ styles.text_font, { color: '#AEB6BF', fontSize: 14, marginLeft: 10 }]}>{this.state.shop.shop_address}</Text>
                            </View>
                            : null
                            }
                            ...
                            <View style={{ flexDirection: 'row', }}>
                                ...
                                <Text style={[ styles.text_font, { color: '#AEB6BF', fontSize: 14, marginLeft: 10 }]}>{this.state.shop.shop_tel}</Text>
                            </View>
                            : null
                            }
                        </View>
        ...
        return (
            <ScrollView style={{ backgroundColor: '#FFF176', }}>
